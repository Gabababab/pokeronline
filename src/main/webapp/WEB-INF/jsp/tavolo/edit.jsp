								...
								<form:form method="post" modelAttribute="update_tavolo_attr" action="${pageContext.request.contextPath}/tavolo/saveUpdate" novalidate="novalidate" class="row g-3">
									...
									<div class="col-md-6">
										...
										<spring:bind path="esperienzaMinima">
											<input type="number" class="form-control ${status.error ? 'is-invalid' : ''}" name="esperienzaMinima" id="esperienzaMinima" placeholder="Inserire esperienza minima" value="${update_tavolo_attr.esperienzaMinima }">
										</spring:bind>
										<form:errors  path="esperienzaMinima" cssClass="error_field" />
									</div>
									
									<div class="col-md-6">
										<label for="creditoMinimo" class="form-label">Cifra minima</label>
										<spring:bind path=""creditoMinimo"">
											<input type="number" class="form-control ${status.error ? 'is-invalid' : ''}" name=""creditoMinimo"" id=""creditoMinimo"" placeholder="Inserire la cifra minima" value="${update_tavolo_attr.creditoMinimo }">
										</spring:bind>
