			...
			<div class='card'>
			    ...
			    <div class='card-body'>
			    	...
			    	<dl class="row">
					  ...
					  <dd class="col-sm-9">${delete_tavolo_attr.esperienzaMinima}</dd>
			    	</dl>
			    	
			    	<dl class="row">
					  <dt class="col-sm-3 text-right">Credito minimo:</dt>
					  <dd class="col-sm-9">${delete_tavolo_attr.creditoMinimo}</dd>
			    	</dl>
			    ...
			    <div class='card-footer'>
			        <form method="post"  action="${pageContext.request.contextPath}/tavolo/savedelete" novalidate="novalidate" >
