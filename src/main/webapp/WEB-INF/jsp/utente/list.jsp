			                	...
			                	<c:forEach items="${utente_list_attribute }" var="utenteItem">
									<tr>
										...
										<td>
											...
											<form action="${pageContext.request.contextPath}/utente/resetpw/${utenteItem.id }" method="post">
												<input type="hidden" value="${utenteItem.id}" name="idUtente">
												<input type="submit" class="btn btn-sm btn-warning" value="Reset Password">
											</form>
										</td>
									</tr>
								</c:forEach>
